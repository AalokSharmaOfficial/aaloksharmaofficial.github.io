...
const AudioRecorder: React.FC<AudioRecorderProps> = ({ onRecordingComplete, existingBlob, onDelete }) => {
  ...
  if (existingBlob) {
    return (
        <div className="w-full p-3 rounded-md bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800 flex items-center justify-between">
            <div className="flex items-center gap-3">
                ...
                <span className="text-sm font-medium text-indigo-800 dark:text-indigo-300">Audio Note Added</span>
            </div>
            <button 
                onClick={onDelete}
    ...
    <div className="w-full">
      {!isRecording ? (
        <button 
          ...
          className="w-full flex items-center justify-center gap-3 p-2 rounded-md text-sm text-slate-700 dark:text-slate-300 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 transition-colors"
        >
