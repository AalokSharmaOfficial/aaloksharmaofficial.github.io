  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 animate-fade-in">
        ...
        <div className="mt-8 space-y-4">
            ...
            <div className="bg-white/50 dark:bg-slate-800/50 p-4 rounded-lg shadow-sm border border-slate-200 dark:border-slate-700 flex items-center justify-between">
                <div>
                    <h3 className="font-semibold text-slate-700 dark:text-slate-200">Export Data</h3>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Download all your diary entries as a JSON file.</p>
                </div>
                <button onClick={onExportData} className="px-4 py-2 text-sm font-semibold bg-slate-100 text-slate-700 rounded-md hover:bg-slate-200 dark:bg-slate-700 dark:text-slate-200 dark:hover:bg-slate-600">
                    Export
                </button>
            </div>
        </div>
